    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 mx-auto">
        <Card
          ...
          description="I'll collaborate to map out your website's goals, target audience, and content strategy. We'll create a sitemap and wireframes to plan the user experience and design."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          description="I'll design mockups and prototypes for your website. We'll refine the design until it's pixel-perfect and you're happy with the result."
        ...
        <Card
          description="I'll develop your website using modern technologies like Next.js and Tailwind CSS. We'll make sure your website is fast, accessible, and SEO-friendly."
